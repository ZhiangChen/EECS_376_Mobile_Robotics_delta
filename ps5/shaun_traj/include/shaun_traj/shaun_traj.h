#ifndef SHAUN_SHAUN_H_
#define SHAUN_SHAUN_H_
...
const double default_accel_max = 0.5; //1m/sec^2 0.5, 1 
const double default_alpha_max = 0.2; //1 rad/sec^2 0.2
