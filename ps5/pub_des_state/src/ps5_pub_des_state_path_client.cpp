...
int main(int argc, char **argv) {
    ros::init(argc, argv, "ps5_append_path_client");
    ros::NodeHandle n;
    ros::ServiceClient client = n.serviceClient<pub_des_state::path>("append_path_queue_service");
