...
int main(int argc, char **argv) {
    ...
    //put some points in the path queue--hard coded here
  	...
  	desStatePublisher.append_path_queue(0,9.5,0);
  	desStatePublisher.append_path_queue(-26.5,9.5,0);
  	desStatePublisher.append_path_queue(-26.5,20,0);
    	desStatePublisher.append_path_queue(-26.5,9.5,0);
	desStatePublisher.append_path_queue(0,9.5,0);
	desStatePublisher.append_path_queue(0,0,0);
